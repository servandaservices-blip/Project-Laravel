...
@section('content')
    @php
        ...
        $positionSummaryCards = $positionSummaryCards ?? [];
    @endphp
    ...
    <section x-data="{ positionModalOpen: false, selectedPosition: null, positionSearch: '' }" @keydown.escape.window="positionModalOpen = false" class="space-y-6">
        <div class="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
            <div class="max-w-3xl">
                <p class="text-[11px] font-semibold uppercase tracking-[0.24em] text-sky-700">Attendance Position Dashboard</p>
                <h2 class="mt-2 text-3xl font-bold tracking-tight text-slate-900">Attendance Position {{ $companyName }}</h2>
            ...
            <form method="GET" action="{{ route('dashboard.attendance-position') }}" class="w-full xl:max-w-[1040px]">
